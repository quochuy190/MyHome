...
public class PhoneUtil {
    ...
    public static boolean isPhoneNumberNew(String receiver) {
        ...
        if (receiver.length() > 11
                ...
                receiver.startsWith("3") || receiver.startsWith("8")
                || receiver.startsWith("52") || receiver.startsWith("56")
                || receiver.startsWith("58") || receiver.startsWith("59")
                || receiver.startsWith("70") || receiver.startsWith("76")
                || receiver.startsWith("77") || receiver.startsWith("78") || receiver.startsWith("79")))
                || (receiver.length() == 10 && !(receiver.startsWith("09") ||
                receiver.startsWith("03") || receiver.startsWith("08")
                || receiver.startsWith("052") || receiver.startsWith("056")
                || receiver.startsWith("058") || receiver.startsWith("059")
                || receiver.startsWith("070") || receiver.startsWith("076")
                || receiver.startsWith("077") || receiver.startsWith("078") || receiver.startsWith("079")))
                || (receiver.length() == 11 && !(receiver.startsWith("849") ||
                receiver.startsWith("843") || receiver.startsWith("848")
                || receiver.startsWith("8452") || receiver.startsWith("8456")
                || receiver.startsWith("8458") || receiver.startsWith("8459")
                || receiver.startsWith("8470") || receiver.startsWith("8476")
                || receiver.startsWith("8477") || receiver.startsWith("8478") || receiver.startsWith("8479")))) {
            ok = false;
        } else {
