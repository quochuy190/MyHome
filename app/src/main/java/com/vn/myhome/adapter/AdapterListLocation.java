...
public class AdapterListLocation extends RecyclerView.Adapter<AdapterListLocation.TopicViewHoder> {
    private List<ObjCity> mList;
    ...
    public AdapterListLocation(List<ObjCity> listAirport, Context context) {
    ...
    public void updateList(List<ObjCity> list) {
        mList = list;
