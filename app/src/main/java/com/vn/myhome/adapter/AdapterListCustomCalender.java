...
public class AdapterListCustomCalender extends
        RecyclerView.Adapter<AdapterListCustomCalender.CalendarCustomView> {
    ...
    public AdapterListCustomCalender(Context context, List<ObjCalendar> mLisCateService,
    ...
    public void onBindViewHolder(@NonNull CalendarCustomView holder, int position) {
        ...
        holder.horizontalAdapter.setData(mListCalendar.get(position).getmLisday()); // List of Strings
    }
    ...
    public static class CalendarCustomView extends RecyclerView.ViewHolder {
        ...
        private Adapter_Item_Day_Custom horizontalAdapter;
        ...
        public CalendarCustomView(View view) {
            ...
            horizontalAdapter = new Adapter_Item_Day_Custom(mContext, onListenerItemClickObjService);
