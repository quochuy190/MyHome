...
public class AdapterRoute extends RecyclerView.Adapter<AdapterRoute.TopicViewHoder> {
    ...
    public AdapterRoute(List<ObjRoute> listAirport, Context context) {
    ...
    public void onBindViewHolder(TopicViewHoder holder, int position) {
        ObjRoute obj = mList.get(position);
    ...
    public void updateList(List<ObjRoute> list) {
        mList = list;
